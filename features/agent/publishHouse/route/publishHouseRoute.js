...
const { publishHouse, getAllPublishedHouses, getHousesPublishedByAgent } = require('../controller/publishHouseController')
...
const   route = require('express').Router()
 ...
 route.post('/my-houses-publised',authHandlerMiddleWare,getHousesPublishedByAgent)
